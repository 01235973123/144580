		...
		<?php if ($this->item->address && $this->params->get('show_street_address')) : ?>
			<dd>
				<span class="contact-street" itemprop="streetAddress">
					<i class="fa fa-map-marker"></i> <?php echo nl2br($this->item->address, false); ?>
				</span>
			</dd>
		<?php endif; ?>
...
<?php if ($this->item->email_to && $this->params->get('show_email')) : ?>
	...
	<dd>
		<span class="contact-emailto">
			<i class="fa fa-envelope-o"></i> <?php echo $this->item->email_to; ?>
		</span>
	</dd>
<?php endif; ?>
...
<?php if ($this->item->telephone && $this->params->get('show_telephone')) : ?>
	...
	<dd>
		<span class="contact-telephone" itemprop="telephone">
			 <i class="fa fa-phone"></i> <?php echo $this->item->telephone; ?>
		</span>
	</dd>
<?php endif; ?>
