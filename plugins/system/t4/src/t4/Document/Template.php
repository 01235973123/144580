...
class Template
{
	...
	public function afterRender()
	{
		...
		if (defined("T4_BS5")) {
			$buffer = str_replace(array('data-toggle', 'data-title', 'data-dismiss', 'data-trigger', 'data-target', 'data-slide', 'data-ride'), array('data-bs-toggle', 'data-bs-title', 'data-bs-dismiss', 'data-bs-trigger', 'data-bs-target', 'data-slide', 'data-ride'), $buffer);
		}
		$app->setBody($buffer);
	}
