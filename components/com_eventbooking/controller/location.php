...
class EventbookingControllerLocation extends EventbookingController
{
	...
	public function save()
	{
		...
		if ($this->app->getIdentity()->authorise('eventbooking.addlocation', 'com_eventbooking'))
		{
			...
			$this->setRedirect(
				Route::_(EventbookingHelperRoute::getViewRoute('locations', $this->input->getInt('Itemid', 0)), false),
				$msg
			);
		}
	}
	...
	public function delete()
	{
		...
		$this->setRedirect(
			Route::_('index.php?option=com_eventbooking&view=locations&Itemid=' . $this->input->getInt('Itemid', 0)),
			Text::_('EB_LOCATION_REMOVED')
		);
	}
	...
	public function cancel()
	{
		$this->setRedirect(
			Route::_(
				'index.php?option=com_eventbooking&view=locations&Itemid=' . $this->input->getInt('Itemid', 0),
				false
			)
		);
	}
