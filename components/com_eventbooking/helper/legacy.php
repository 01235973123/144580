...
class EventbookingHelperLegacy
{
	...
	public static function processDownload($filePath, $filename, $detectFilename = false)
	{
		...
		$ext  = EventbookingHelper::getFileExt($filename);
	...
	public static function getMimeType($ext)
	{
		...
		return $mimeExtensionMap[$ext] ?? 'application/octet-stream';
	}
	...
	public static function getDeliciousButton($title, $link)
	{
		...
		return '<a href="http://del.icio.us/post?url=' . rawurlencode($link) . '&amp;title=' . rawurlencode(
				$title
			) . '" title="' . $alt . '" target="blank" >
	...
	public static function getDiggButton($title, $link)
	{
		...
		return '<a href="http://digg.com/submit?url=' . rawurlencode($link) . '&amp;title=' . rawurlencode(
				$title
			) . '" title="' . $alt . '" target="blank" >
        <img src="' . $img_url . '" alt="' . $alt . '" />
        </a>';
	...
	public static function getFacebookButton($title, $link)
	{
		...
		return '<a href="http://www.facebook.com/sharer.php?u=' . rawurlencode($link) . '&amp;t=' . rawurlencode(
				$title
			) . '" title="' . $alt . '" target="blank" >
        <img src="' . $img_url . '" alt="' . $alt . '" />
        </a>';
	...
	public static function getGoogleButton($title, $link)
	{
		...
		return '<a href="http://www.google.com/bookmarks/mark?op=edit&bkmk=' . rawurlencode(
				$link
			) . '" title="' . $alt . '" target="blank" >
        <img src="' . $img_url . '" alt="' . $alt . '" />
        </a>';
	...
	public static function getStumbleuponButton($title, $link)
	{
		...
		return '<a href="http://www.stumbleupon.com/submit?url=' . rawurlencode($link) . '&amp;title=' . rawurlencode(
				$title
			) . '" title="' . $alt . '" target="blank" >
        <img src="' . $img_url . '" alt="' . $alt . '" />
        </a>';
