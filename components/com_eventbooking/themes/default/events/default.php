...
?>
<div id="eb-events-manage-page" class="eb-container eb-joomla4-container">
			...
			<table class="<?php echo $bootstrapHelper->getClassMapping('table table-striped table-bordered table-considered'); ?>">
				<thead>
					<tr>
						...
						<?php
						if ($this->params->get('show_category_column', 1))
						{
							$cols++;
						?>
						...
						if ($this->params->get('show_event_date_column', 1))
						{
							$cols++;
						?>
						...
						if ($this->params->get('show_number_registrants_column', 1))
						{
							$cols++;
						?>
						...
						if ($this->params->get('show_status_column', 1))
						{
							$cols++;
						?>
						...
						if ($this->params->get('show_id_column', 1))
						{
							$cols++;
						?>
