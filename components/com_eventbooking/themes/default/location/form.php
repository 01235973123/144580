	...
	<div  class="<?php echo $span5Class ?>">
		<div class="<?php echo $controlGroupClass;  ?>">
			...
			<div class="<?php echo $controlsClass; ?>">
				<input class="form-control" type="text" name="name" id="name" maxlength="250" value="<?php echo $this->escape($this->item->name);?>" />
			</div>
		</div>
		...
		<div class="<?php echo $controlGroupClass;  ?>">
			...
			<div class="<?php echo $controlsClass; ?>">
				 <input class="form-control" type="text" name="address" id="address" autocomplete="off" maxlength="250" value="<?php echo $this->escape($this->item->address);?>" />
		...
		<div class="<?php echo $controlGroupClass;  ?>">
			...
			<div class="<?php echo $controlsClass; ?>">
				<input class="form-control" type="text" name="coordinates" id="coordinates" maxlength="250" value="<?php echo $this->item->lat . ',' . $this->item->long;?>" />
			</div>
		</div>
