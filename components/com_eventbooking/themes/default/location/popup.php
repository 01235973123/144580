...
$rowFluild         = $bootstrapHelper->getClassMapping('row-fluid');
		...
		<div  class="<?php echo $span5Class ?>">
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input class="form-control validate[required]" type="text" name="name" id="name" maxlength="250" value="<?php echo $this->escape($this->item->name); ?>" />
				</div>
			</div>
			...
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					 <input class="form-control validate[required]" type="text" name="address" id="address" autocomplete="off" maxlength="250" value="<?php echo $this->escape($this->item->address);?>" />
			...
			?>
				<div class="<?php echo $controlGroupClass;  ?>">
					...
					<div class="<?php echo $controlsClass; ?>">
						<input class="form-control" type="text" name="city" id="city" maxlength="250" value="<?php echo $this->escape($this->item->city);?>" />
					</div>
				</div>
			<?php
			}
			...
			?>
				<div class="<?php echo $controlGroupClass;  ?>">
					...
					<div class="<?php echo $controlsClass; ?>">
						<input class="form-control" type="text" name="state" id="state" maxlength="250" value="<?php echo $this->escape($this->item->state);?>" />
					</div>
				</div>
			<?php
			}
			...
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input class="form-control validate[required]" type="text" name="coordinates" id="coordinates" maxlength="250" value="" />
				</div>
			</div>
			<div class="<?php echo $controlGroupClass;  ?>">
				<label class="<?php echo $controlLabelClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<?php echo EventbookingHelperHtml::getBooleanInput('published', $this->item->published); ?>
				</div>
			</div>
		 </div>
