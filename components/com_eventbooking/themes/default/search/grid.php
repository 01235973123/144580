...
?>
<div id="eb-search-result-grid-layout" class="eb-container">
<h1 class="eb-page-heading"><?php echo $this->escape(Text::_('EB_SEARCH_RESULT')); ?></h1>
	...
	?>
	<form method="post" name="adminForm" id="adminForm" action="<?php echo Route::_('index.php?option=com_eventbooking&view=search&layout=grid&Itemid=' . $this->Itemid); ?>">
