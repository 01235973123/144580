...
{
	$inputClass = $inputMediumClass . ' uk-input';
}
else
{
	$inputClass = $inputSmallClass . ' form-control';
}
...
<div id="eb-amount-container" class="<?php echo $controlGroupClass;  ?>">
	...
	<div class="<?php echo $controlsClass; ?>">
		<?php
			$input = '<input id="total_amount" type="text" readonly="readonly" class="' . $inputClass . '" value="' . EventbookingHelper::formatAmount($this->totalAmount, $this->config) . '" />';

			echo $bootstrapHelper->getAddon($input, $currencySymbol, $this->config->currency_position);
		?>
	</div>
</div>
<?php
...
?>
	<div id="eb-discount-amount-container" class="<?php echo $controlGroupClass;  ?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<?php
			$input = '<input id="discount_amount" type="text" readonly="readonly" class="' . $inputClass . '" value="' . EventbookingHelper::formatAmount($this->discountAmount, $this->config) . '" />';
...
if($this->lateFee > 0 || (isset($this->event) && $this->event->late_fee_amount > 0))
{
?>
	<div id="eb-late-fee-container" class="<?php echo $controlGroupClass;  ?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<?php
			$input = '<input id="late_fee" type="text" readonly="readonly" class="' . $inputClass . '" value="' . EventbookingHelper::formatAmount($this->lateFee, $this->config) . '" />';
			echo $bootstrapHelper->getAddon($input, $currencySymbol, $this->config->currency_position);
			?>
		</div>
	</div>
...
?>
	<div id="eb-tax-amount-container" class="<?php echo $controlGroupClass;  ?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<?php
			$input = '<input id="tax_amount" type="text" readonly="readonly" class="' . $inputClass . '" value="' . EventbookingHelper::formatAmount($this->taxAmount, $this->config) . '" />';
...
?>
	<div id="eb-payment-processing-fee-container" class="<?php echo $controlGroupClass;  ?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<?php
			$input = '<input id="payment_processing_fee" type="text" readonly="readonly" class="' . $inputClass . '" value="' . EventbookingHelper::formatAmount($this->paymentProcessingFee, $this->config) . '" />';
...
?>
	<div id="eb-gross-amount-container" class="<?php echo $controlGroupClass;  ?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<?php
			$input = '<input id="amount" type="text" readonly="readonly" class="' . $inputClass . '" value="' . EventbookingHelper::formatAmount($this->amount, $this->config) . '" />';
...
if ($this->depositPayment)
{
	...
	<div id="deposit_amount_container" class="<?php echo $controlGroupClass; ?>"<?php echo $style; ?>>
		...
		<div class="<?php echo $controlsClass; ?>">
			<?php
			$input = '<input id="deposit_amount" type="text" readonly="readonly" class="' . $inputClass . '" value="' . EventbookingHelper::formatAmount($this->depositAmount, $this->config) . '" />';
