...
if ($this->config->get('fes_show_enable_cancel_registration', 1))
{
?>
	<div class="<?php echo $controlGroupClass; ?>">
		<div class="<?php echo $controlLabelClass; ?>">
	...
	<div class="<?php echo $controlGroupClass; ?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<?php echo HTMLHelper::_('calendar', $this->item->cancel_before_date, 'cancel_before_date', 'cancel_before_date', $this->datePickerFormat . ' %H:%M:%S'); ?>
		</div>
	</div>
<?php
}
