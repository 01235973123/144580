...
?>
	<div class="<?php echo $controlGroupClass; ?>" data-showon='<?php echo EventbookingHelperHtml::renderShowOn($showOnData); ?>'>
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" name="recurring_frequency" id="recurring_frequency" size="5" class="form-control" value="<?php echo $this->item->recurring_frequency; ?>"/>
		</div>
	</div>
	...
	<div class="<?php echo $controlGroupClass; ?>" data-showon='<?php echo EventbookingHelperHtml::renderShowOn($showOnData); ?>'>
		...
		<div class="<?php echo $controlsClass; ?>">
			<?php echo HTMLHelper::_('calendar', $this->item->recurring_end_date, 'recurring_end_date', 'recurring_end_date', $this->datePickerFormat); ?>
		</div>
	</div>
	<div class="<?php echo $controlGroupClass; ?>" data-showon='<?php echo EventbookingHelperHtml::renderShowOn($showOnData); ?>'>
		<div class="<?php echo $controlLabelClass; ?>">
