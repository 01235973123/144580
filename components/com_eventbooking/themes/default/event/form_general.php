...
<div class="<?php echo $controlGroupClass;?>">
	...
	<div class="<?php echo $controlsClass; ?>">
		<input type="text" name="title" value="<?php echo $this->escape($this->item->title); ?>" class="form-control" />
	</div>
</div>
<?php
...
?>
    <div class="<?php echo $controlGroupClass;?>">
        ...
        <div class="<?php echo $controlsClass; ?>">
            <input type="number" name="min_group_number" id="min_group_number" class="form-control" size="10" value="<?php echo $this->item->min_group_number; ?>" />
        </div>
    </div>
<?php
}
...
?>
	<div class="<?php echo $controlGroupClass;?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" name="max_group_number" id="max_group_number" class="form-control" size="10" value="<?php echo $this->item->max_group_number; ?>" />
		</div>
	</div>
<?php
}
...
?>
	...
	<div class="<?php echo $controlGroupClass;?>">
		...
		<div class="<?php echo $controlsClass; ?>">
			<input type="number" class="form-control input-medium d-inline-block" name="send_third_reminder" value="<?php echo $this->item->send_third_reminder; ?>" size="5" /><span><?php echo ' ' . $this->lists['third_reminder_frequency'] . ' ' . $this->lists['send_third_reminder_time']; ?></span><?php echo Text::_('EB_EVENT_STARTED'); ?>
		</div>
	</div>
<?php
}
