...
<table  id="price_list">
	...
	for ($i = 0 ; $i < $n ; $i++)
	{
		...
		<tr>
			<td>
				<input type="text" class="input-small form-control" name="registrant_number[]" value="<?php echo $registrantNumber; ?>" />
			</td>
			<td>
				<input type="text" class="input-small form-control" name="price[]" value="<?php echo $price; ?>" />
			</td>
		</tr>
		<?php
	}
