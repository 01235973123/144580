	...
	<form action="<?php echo Route::_('index.php?option=com_eventbooking&view=events&Itemid=' . $this->Itemid); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="<?php echo $formHorizontal; ?>">
		...
		<div class="<?php echo $controlGroupClass;  ?>">
			...
			<div class="<?php echo $controlsClass; ?>">
				<input type="text" name="title" value="<?php echo $this->escape($this->item->title); ?>" class="validate[required] form-control" />
			</div>
		</div>
		<?php
		...
		?>
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="alias" value="<?php echo $this->item->alias; ?>" class="form-control"/>
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass;?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="image_alt" value="<?php echo $this->item->image_alt; ?>" class="form-control" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<?php echo HTMLHelper::_('calendar', $this->item->publish_up, 'publish_up', 'publish_up', $this->datePickerFormat . ' %H:%M:%S'); ?>
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<?php echo HTMLHelper::_('calendar', $this->item->publish_down, 'publish_down', 'publish_down', $this->datePickerFormat . ' %H:%M:%S'); ?>
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="number" name="individual_price" id="individual_price" class="form-control" value="<?php echo $this->item->individual_price; ?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="price_text" id="price_text" class="form-control" value="<?php echo $this->escape($this->item->price_text); ?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
            <div class="<?php echo $controlGroupClass;?>">
                ...
                <div class="<?php echo $controlsClass; ?>">
                    <input type="number" name="tax_rate" id="tax_rate" class="form-control" value="<?php echo $this->item->tax_rate; ?>" />
                </div>
            </div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="number" min="0" step="1" name="event_capacity" id="event_capacity" class="form-control" value="<?php echo $this->item->event_capacity; ?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass;?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="number" min="0" step="1" name="private_booking_count" id="private_booking_count" class="form-control" value="<?php echo $this->item->private_booking_count; ?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass;?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="number" min="0" step="1" name="waiting_list_capacity" id="waiting_list_capacity" class="form-control" value="<?php echo $this->item->waiting_list_capacity; ?>" />
				</div>
			</div>
		<?php
		}
			...
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="url" name="registration_handle_url" id="registration_handle_url"
						   class="form-control" value="<?php echo $this->item->registration_handle_url; ?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="notification_emails" class="form-control" value="<?php echo $this->item->notification_emails ; ?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="paypal_email" class="form-control" value="<?php echo $this->item->paypal_email ; ?>" />
				</div>
			</div>
		<?php
		}
		...
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="event_password" id="event_password" class="form-control" value="<?php echo $this->item->event_password; ?>"/>
				</div>
			</div>
		<?php
		}
		...
		?>
			...
			<div class="<?php echo $controlGroupClass;  ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					<input type="text" name="currency_symbol" class="form-control" value="<?php echo $this->item->currency_symbol; ?>" />
				</div>
			</div>
		<?php
		}
