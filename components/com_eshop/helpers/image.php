...
class EShopImage
{
	...
	public function resize($width = 0, $height = 0)
	{
		...
		$resizedImageBackground = EShopHelper::getConfigValue('resized_image_background', 'FFFFFF');
		[$red, $green, $blue] = sscanf('#' . $resizedImageBackground, '#%02x%02x%02x');

		if (isset($this->info['mime']) && $this->info['mime'] == 'image/png')
		{
			imagealphablending($this->image, false);
			imagesavealpha($this->image, true);
			$background = imagecolorallocatealpha($this->image, $red, $green, $blue, 127);
