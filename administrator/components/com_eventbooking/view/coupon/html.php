...
class EventbookingViewCouponHtml extends RADViewItem
{
	...
	/**
	 * The registrants use this coupon code
	 *
	 * @var array
	 */
	protected $registrants;
	/**
	 * Coupon assignment flag
	 *
	 * @var int
	 */
	...
	protected function prepareView()
	{
		...
		$this->lists['coupon_type'] = HTMLHelper::_(
			'select.genericlist',
			$options,
			'coupon_type',
		...
		$this->lists['apply_to'] = HTMLHelper::_(
			'select.genericlist',
			$options,
			'apply_to',
		...
		$this->lists['enable_for'] = HTMLHelper::_(
			'select.genericlist',
			$options,
			'enable_for',
			'class="form-select d-inline-block"',
		...
		$this->lists['category_id'] = HTMLHelper::_('select.genericlist', $options, 'category_id[]', [
			...
			'option.text'        => 'text',
			'option.value'       => 'value',
			'list.attr'          => 'class="input-xlarge form-select" multiple',
