...
<fieldset class="form-horizontal options-form eb-event-misc">
	...
	?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="number" name="min_group_number" id="min_group_number" class="form-control" value="<?php echo $this->item->min_group_number; ?>"/>
			</div>
		</div>
	<?php
	}
	...
	?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="number" name="max_group_number" id="max_group_number" class="form-control" value="<?php echo $this->item->max_group_number; ?>"/>
			</div>
		</div>
	<?php
	}
	...
	?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="number" name="deposit_amount" id="deposit_amount" class="form-control" value="<?php echo $this->item->deposit_amount; ?>"/>&nbsp;&nbsp;<?php echo $this->lists['deposit_type']; ?>
			</div>
		</div>
        <div class="control-group">
            <div class="control-label">
	...
	?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="url" class="form-control" name="registration_complete_url" value="<?php echo $this->item->registration_complete_url; ?>" size="50" />
			</div>
		</div>
	<?php
	}
	...
	?>
		<div class="control-group">
			...
			<div class="controls">
				<input type="url" class="form-control" name="offline_payment_registration_complete_url" value="<?php echo $this->item->offline_payment_registration_complete_url; ?>" size="50" />
			</div>
		</div>
	<?php
	}
