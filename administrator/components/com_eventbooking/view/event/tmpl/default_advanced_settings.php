...
<div class="control-group">
	...
	<div class="controls">
		<input type="number" class="form-control" min="0" step="0.01" name="fixed_group_price" id="fixed_group_price" value="<?php echo $this->item->fixed_group_price; ?>" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<?php
	...
	?>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="api_login" value="<?php echo $this->item->api_login; ?>" class="form-control" />
            </div>
        </div>
        <div class="control-group">
            <div class="control-label"><?php echo Text::_('EB_TRANSACTION_KEY') ; ?></div>
            <div class="controls">
                <input type="text" name="transaction_key" value="<?php echo $this->item->transaction_key; ?>" class="form-control" />
            </div>
        </div>
    <?php
	}
...
<div class="control-group">
	...
	<div class="controls">
		<input type="text" name="from_name" class="form-control" value="<?php echo $this->item->from_name ; ?>" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
	...
	<div class="controls">
		<input type="text" name="from_email" class="form-control" value="<?php echo $this->item->from_email; ?>" />
	</div>
</div>
<div class="control-group">
    <div class="control-label">
    ...
    <div class="controls">
        <input type="text" name="reply_to_email" class="form-control" value="<?php echo $this->item->reply_to_email; ?>" />
    </div>
</div>
<div class="control-group">
	<div class="control-label">
