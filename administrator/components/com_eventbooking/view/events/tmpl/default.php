	...
	<div id="j-main-container" class="eb-joomla4-container">
		...
		<table class="table itemList table-striped" id="eventList">
			...
			<tr>
				...
				?>
					<th class="center">
						<?php echo Text::_('EB_NUMBER_WAITING_LIST'); ?>
					</th>
				<?php
				}
			...
			for ($i = 0, $n = count($this->items); $i < $n; $i++)
			{
				...
				<tr class="<?php echo implode(' ', $classes); ?>">
					...
					?>
						<td class="center">
							<a href="<?php echo Route::_('index.php?option=com_eventbooking&view=registrants&filter_event_id=' . $row->id.'&filter_published=3');?>"><?php echo (int) $row->number_waiting_lists; ?></a>
						</td>
					<?php
					}
