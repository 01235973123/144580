...
<div class="control-group">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo EventbookingHelperHtml::getFieldLabel('export_deposit_payment_status', Text::sprintf('EB_EXPORT_FIELD', Text::_('EB_DEPOSIT_PAYMENT_STATUS'))); ?>
		</div>
		<div class="controls">
			<?php echo EventbookingHelperHtml::getBooleanInput('export_deposit_payment_status', $config->get('export_deposit_payment_status', 0)); ?>
		</div>
	</div>
<div class="control-group">
	<div class="control-label">
