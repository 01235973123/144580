...
<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('custom_field_assignment', Text::_('EB_CUSTOM_FIELDS_ASSIGNMENT'), Text::_('EB_CUSTOM_FIELDS_ASSIGNMENT_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<?php echo $this->lists['custom_field_assignment']; ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
            ...
            <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowon(['twitter_bootstrap_version' => ['2', '5']]); ?>'>
                <div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['event_custom_field' => '1']); ?>'>
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('validate_event_custom_field', Text::_('EB_VALIDATE_EVENT_CUSTOM_FIELD')); ?>
				</div>
				<div class="controls">
					<?php echo $this->lists['validate_event_custom_field']; ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
            ...
            <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['show_children_events_under_parent_event' => '1']); ?>'>
                <div class="control-label">
        ...
        <fieldset class="form-horizontal options-form" style="margin-top:3px;">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="event_time_format" class="form-control" value="<?php echo $config->event_time_format ?: '%I%P'; ?>" size="40" />
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['map_provider' => 'googlemap']); ?>'>
				<div class="control-label">
	...
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		<fieldset class="form-horizontal options-form">
			...
			?>
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['user_registration' => '0']); ?>'>
				<div class="control-label">
            ...
            <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['multiple_booking' => '1']); ?>'>
                <div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['multiple_booking' => '1']); ?>'>
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('add_more_events_menu_item_id', Text::_('EB_ADD_MORE_EVENTS_MENU_ITEM'), Text::_('EB_ADD_MORE_EVENTS_MENU_ITEM_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getEBMenuItemInput('add_more_events_menu_item_id', $config->add_more_events_menu_item_id); ?>
				</div>
			</div>
            <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['multiple_booking' => '0']); ?>'>
                <div class="control-label">
            ...
            <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['activate_deposit_feature' => '1']); ?>'>
                <div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['activate_waitinglist_feature' => '1']); ?>'>
				<div class="control-label">
            ...
            <div class="control-group" <div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['enable_ics_export' => '1']); ?>'>
                <div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['enable_coupon' => '1']); ?>'>
				<div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['show_price_including_tax' => '1']); ?>'>
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
                    <?php echo EventbookingHelperHtml::getFieldLabel('validate_checkin_date', Text::_('EB_VALIDATE_CHECKIN_DATE'), Text::_('EB_VALIDATE_CHECKIN_DATE_EXPLAIN')); ?>
				</div>
				<div class="controls">
                    <?php echo EventbookingHelperHtml::getBooleanInput('validate_checkin_date', $config->get('validate_checkin_date', 1)); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['accept_term' => '1']); ?>'>
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('number_fields_per_row', Text::_('EB_NUMBER_FIELDS_PER_ROW')); ?>
				</div>
				<div class="controls">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('resized_webp_image_quality', Text::_('EB_RESIZED_WEBP_IMAGE_QUALITY')); ?>
				</div>
				<div class="controls">
					<?php echo $this->lists['resized_webp_image_quality'];?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group" data-showon='<?php echo EventbookingHelperHtml::renderShowOn(['resize_event_large_image' => '1']); ?>'>
				<div class="control-label">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('default_event_date_hour', Text::_('EB_DEFAULT_EVENT_DATE_HOUR')); ?>
				</div>
				<div class="controls">
					<input type="number" name="default_event_date_hour" class="form-control" min="0" max="23" step="1" value="<?php echo (int) $this->config->get('default_event_date_hour', 0); ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('default_event_date_minute', Text::_('EB_DEFAULT_EVENT_DATE_MINUTE')); ?>
				</div>
				<div class="controls">
					<input type="number" name="default_event_date_minute" class="form-control" min="0" max="59" step="1" value="<?php echo (int) $this->config->get('default_event_date_minute', 0); ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('default_event_end_date_hour', Text::_('EB_DEFAULT_EVENT_END_DATE_HOUR')); ?>
				</div>
				<div class="controls">
					<input type="number" name="default_event_end_date_hour" class="form-control" min="0" max="23" step="1" value="<?php echo (int) $this->config->get('default_event_end_date_hour', 0); ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('default_event_end_date_minute', Text::_('EB_DEFAULT_EVENT_END_DATE_MINUTE')); ?>
				</div>
				<div class="controls">
					<input type="number" name="default_event_end_date_minute" class="form-control" min="0" max="59" step="1" value="<?php echo (int) $this->config->get('default_event_end_date_minute', 0); ?>" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('default_max_number_registrants', Text::_('EB_DEFAULT_MAX_NUMBER_REGISTRANTS'), Text::_('EB_DEFAULT_MAX_NUMBER_REGISTRANTS_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<input type="text" name="default_max_number_registrants" class="form-control" value="<?php echo $config->default_max_number_registrants; ?>" size="60" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="number" name="upload_max_file_size" class="form-control input-small d-inline-block" value="<?php echo $config->get('upload_max_file_size'); ?>" size="60" /> MB
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('allow_using_html_on_title', Text::_('EB_ALLOW_HTML_ON_TITLE'), Text::_('EB_ALLOW_HTML_ON_TITLE_EXPLAIN')); ?>
				</div>
				<div class="controls">
			...
			?>
				<div class="control-group">
					<div class="control-label">
						<?php echo EventbookingHelperHtml::getFieldLabel('display_php_version_warning', Text::_('Display PHP Version Warning')); ?>
					</div>
					<div class="controls">
						<?php echo EventbookingHelperHtml::getBooleanInput('display_php_version_warning', $config->get('display_php_version_warning', 1)); ?>
					</div>
				</div>
			<?php
			}
...
<input type="hidden" name="custom_field_by_category" value="<?php echo $config->get('custom_field_by_category', 0) ?>" />
