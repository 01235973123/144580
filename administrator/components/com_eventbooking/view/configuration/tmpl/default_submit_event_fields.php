...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_image_alt', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_IMAGE_ALT'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_image_alt', $config->get('fes_show_image_alt', 0)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_location', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_LOCATION'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_location', $config->get('fes_show_location', 1)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_private_booking_count', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_PRIVATE_BOOKING_COUNT'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_private_booking_count', $config->get('fes_show_private_booking_count', 0)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_free_event_registration_status', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_FREE_EVENT_REGISTRATION_STATUS'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_free_event_registration_status', $config->get('fes_show_free_event_registration_status', 0)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_send_emails', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_SEND_NOTIFICATION_EMAILS'))); ?>
	</div>
	<div class="controls">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('fes_show_enable_cancel_registration', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_ENABLE_CANCEL'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('fes_show_enable_cancel_registration', $config->get('fes_show_enable_cancel_registration', 1)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
