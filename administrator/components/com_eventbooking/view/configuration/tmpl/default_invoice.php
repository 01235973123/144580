...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('send_invoice_when_registration_approved', Text::_('EB_SEND_INVOICE_TO_WHEN_REGISTRATION_APPROVED'), Text::_('EB_SEND_INVOICE_TO_WHEN_REGISTRATION_APPROVED_EXPLAIN')); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('send_invoice_when_registration_approved', $config->get('send_invoice_when_registration_approved', 1)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	...
	<div class="controls">
		<input type="number" name="invoice_start_number" class="form-control" value="<?php echo $config->invoice_start_number ?: 1; ?>" size="10" />
	</div>
</div>
<div class="control-group">
	<div class="control-label">
