...
<form action="<?php echo $this->getFormAction(); ?>" method="post" name="adminForm" id="adminForm">
	<div id="j-main-container" class="eb-joomla4-container">
		...
		<table class="table itemList table-striped" id="sponsorsList">
			<thead>
			<tr>
				...
				<th class="title">
					<?php echo $this->searchToolsSort('EB_LOGO',  'tbl.logo'); ?>
				</th>
				<th class="title">
					<?php echo $this->searchToolsSort('EB_WEBSITE',  'tbl.website'); ?>
				</th>
