...
class JFormFieldEBMenuItem extends JFormFieldGroupedList
{
	/**
	 * The form field type.
	 *
	...
	public function getGroups()
	{
		...
		foreach ($items as $item)
		{
			...
			$groups[$item->menutype][] = HTMLHelper::_(
				'select.option',
				$item->id,
				str_repeat('- ', $item->level) . $item->title . $lang
			);
		}
