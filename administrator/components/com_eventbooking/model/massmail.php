...
class EventbookingModelMassmail extends RADModel
{
	...
	public function send($input)
	{
		...
		if ($data['event_id'] >= 1)
		{
			...
			{
				$fileName = JPATH_ROOT . '/media/com_eventbooking/icsfiles/' . ApplicationHelper::stringURLSafe(
						$event->title
					) . '.ics';
				EventbookingHelper::generateIcs([$event],
					EventbookingHelperMail::$fromEmail,
					EventbookingHelperMail::$fromName,
					$fileName);
