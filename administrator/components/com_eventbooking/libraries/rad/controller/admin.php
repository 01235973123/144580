...
class RADControllerAdmin extends RADController
{
	...
	public function __construct(RADInput $input = null, array $config = [])
	{
		...
		$this->viewList = $config['view_list'] ?? RADInflector::pluralize($this->viewItem);
	...
	{
		return $this->app->getIdentity()->authorise('core.delete', $this->option);
	}
	...
	{
		return $this->app->getIdentity()->authorise('core.edit.state', $this->option);
	}
