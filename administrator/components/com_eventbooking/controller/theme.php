...
class EventbookingControllerTheme extends EventbookingController
{
	...
	public function install()
	{
		...
		try
		{
			...
			$this->setRedirect(
				Route::_('index.php?option=com_eventbooking&view=themes', false),
				Text::_('EB_THEME_INSTALLED')
			);
		}
		catch (Exception $e)
		{
			...
			$this->setRedirect(
				Route::_('index.php?option=com_eventbooking&view=themes', false),
				Text::_('EB_THEME_INSTALL_FAILED')
			);
		}
	}
	...
	public function uninstall()
	{
		...
		catch (Exception $e)
		{
			...
			$this->setRedirect(
				Route::_('index.php?option=com_eventbooking&view=themes', false),
				Text::_('EB_THEME_UNINSTALL_FAILED')
			);
		}
	}
	...
	public function publish()
	{
		...
		try
		{
			...
			$this->setRedirect(
				Route::_('index.php?option=com_eventbooking&view=themes', false),
				Text::_('EB_DEFAULT_THEME_CHANGED')
			);
		}
		catch (Exception $e)
		{
			...
			$this->setRedirect(
				Route::_('index.php?option=com_eventbooking&view=themes', false),
				Text::_('EB_ERROR_CHANGING_DEFAULT_THEME')
			);
		}
	}
}
