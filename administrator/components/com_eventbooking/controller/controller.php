...
class EventbookingController extends RADControllerAdmin
{
	...
	public function display($cachable = false, array $urlparams = [])
	{
		...
		$wa->registerAndUseStyle(
			...
			'media/com_eventbooking/assets/admin/css/style.css',
			['version' => $version]
		);
		...
		{
			$wa->registerAndUseStyle(
				'com_eventbooking.light',
				'media/com_eventbooking/assets/admin/css/light51.css',
				['version' => $version]
			);
		}
		else
		{
			$wa->registerAndUseStyle(
				'com_eventbooking.light',
				'media/com_eventbooking/assets/admin/css/light.css',
				['version' => $version]
			);
		}
