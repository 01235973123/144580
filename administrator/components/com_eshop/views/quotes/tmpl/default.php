	...
	<div id="j-main-container">
		<div id="filter-bar" class="btn-toolbar<?php if ($isJoomla4) echo ' js-stools-container-filters-visible'; ?>">
			<div class="filter-search btn-group pull-left">
				<label for="filter_search" class="element-invisible"><?php echo Text::_('ESHOP_FILTER_SEARCH_QUOTES_DESC');?></label>
				<input type="text" name="search" id="filter_search" placeholder="<?php echo Text::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->search); ?>" class="hasTooltip form-control" title="<?php echo HTMLHelper::tooltipText('ESHOP_SEARCH_QUOTES_DESC'); ?>" />
			</div>
		...
		<table class="adminlist table table-striped">
			...
			for ($i = 0, $n = count( $this->items ); $i < $n; $i++)
			{
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					{
					    ?>
					    <td class="text_left"><?php echo $row->telephone; ?></td>
					    <?php
					}
					?>
					<td class="text_center">
					...
					<td class="text_center">
						...
						{
							echo HTMLHelper::_('date', $row->modified_date, $dateFormat, null);
						}
						?>
					</td>
					<td class="text_center">
					...
					<td class="text_center">
						<a href="<?php echo $link; ?>"><?php echo Text::_('ESHOP_VIEW'); ?></a>
					</td>
				</tr>		
				<?php
				$k = 1 - $k;
