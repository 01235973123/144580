		...
		<div class="controls">
			...
			if ($translatable)
			{
				foreach ($this->languages as $language)
				{
					...
					?>
					<input class="input-xlarge form-control" type="text" name="stockstatus_name_<?php echo $langCode; ?>" id="stockstatus_name_<?php echo $langId; ?>" size="" maxlength="255" value="<?php echo $this->item->{'stockstatus_name_'.$langCode} ?? ''; ?>" />
			...
			{
				?>
				<input class="input-xlarge form-control" type="text" name="stockstatus_name" id="stockstatus_name" maxlength="255" value="<?php echo $this->item->stockstatus_name; ?>" />
				<?php
			}
			?>
		</div>
