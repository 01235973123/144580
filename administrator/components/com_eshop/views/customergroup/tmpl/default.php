		...
		<div class="controls">
			...
			if ($translatable)
			{
				foreach ($this->languages as $language)
				{
					...
					?>
					<input class="input-xlarge form-control" type="text" name="customergroup_name_<?php echo $langCode; ?>" id="customergroup_name_<?php echo $langId; ?>" size="" maxlength="255" value="<?php echo $this->item->{'customergroup_name_'.$langCode} ?? ''; ?>" />
			...
			{
				?>
				<input class="input-xlarge form-control" type="text" name="customergroup_name" id="customergroup_name" maxlength="255" value="<?php echo $this->item->customergroup_name; ?>" />
				<?php
			}
			?>
		</div>			
