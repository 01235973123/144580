		...
		<div class="controls">
			...
			if ($translatable)
			{
				foreach ($this->languages as $language)
				{
					...
					?>
					<input class="input-xlarge form-control" type="text" name="attributegroup_name_<?php echo $langCode; ?>" id="attributegroup_name_<?php echo $langId; ?>" size="" maxlength="255" value="<?php echo $this->item->{'attributegroup_name_'.$langCode} ?? ''; ?>" />
			...
			{
				?>
				<input class="input-xlarge form-control" type="text" name="attributegroup_name" id="attributegroup_name" maxlength="255" value="<?php echo $this->item->attributegroup_name; ?>" />
				<?php
			}
			?>
		</div>
