		...
		<div class="controls">
			...
			if ($translatable)
			{
				foreach ($this->languages as $language)
				{
					...
					?>
					<input class="input-xlarge form-control" type="text" name="orderstatus_name_<?php echo $langCode; ?>" id="orderstatus_name_<?php echo $langId; ?>" size="" maxlength="255" value="<?php echo $this->item->{'orderstatus_name_'.$langCode} ?? ''; ?>" />
			...
			{
				?>
				<input class="input-xlarge form-control" type="text" name="orderstatus_name" id="orderstatus_name" maxlength="255" value="<?php echo $this->item->orderstatus_name; ?>" />
				<?php
			}
			?>
		</div>
