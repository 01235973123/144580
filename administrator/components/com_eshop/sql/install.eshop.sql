...
CREATE TABLE IF NOT EXISTS `#__eshop_attributegroupdetails` (
  ...
  `language` char(7) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_attributegroup_id` (`attributegroup_id`),
  KEY `idx_language` (`language`)
) DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `#__eshop_carts`;
CREATE TABLE IF NOT EXISTS `#__eshop_carts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__eshop_categories` (
  ...
  `category_cart_mode_customergroups` text,
...
DROP TABLE IF EXISTS `#__eshop_couponcategories`;
CREATE TABLE IF NOT EXISTS `#__eshop_couponcategories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__eshop_coupons` (
  ...
  `coupon_value` decimal(15,4) DEFAULT NULL,
  `coupon_min_total` decimal(15,4) DEFAULT NULL,
  `coupon_start_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `coupon_end_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  ...
  `coupon_used` decimal(15,4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__eshop_currencies` (
  ...
  `exchanged_value` decimal(15,4) DEFAULT NULL,
  `published` tinyint(1) unsigned DEFAULT NULL,
  `modified_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `idx_published` (`published`)
...
CREATE TABLE IF NOT EXISTS `#__eshop_discounts` (
  ...
  `discount_start_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
DROP TABLE IF EXISTS `#__eshop_geozonepostcodes`;
CREATE TABLE IF NOT EXISTS `#__eshop_geozonepostcodes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `geozone_id` int(11) DEFAULT NULL,
  `start_postcode` varchar(128) DEFAULT NULL,
  `end_postcode` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_geozone_id` (`geozone_id`)
) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__eshop_labels` (
  ...
  `label_opacity` decimal(5,2) DEFAULT NULL,
  ...
  `label_start_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `label_end_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
(47, 'ESHOP_QUESTIONS', 8, 'questions', NULL, 'question', 1, 10);
...
(44, 'Admin Cancel Notification Email Subject', 'admin_cancel_notification_email_subject', 'textbox'),
(45, 'Admin Cancel Notification Email', 'admin_cancel_notification_email', 'textarea'),
(46, '1st Abandon Cart Email Subject', '1st_abandon_cart_email_subject', 'textbox'),
(47, '1st Abandon Cart Email', '1st_abandon_cart_email', 'textarea'),
(48, '2nd Abandon Cart Email Subject', '2nd_abandon_cart_email_subject', 'textbox'),
(49, '2nd Abandon Cart Email', '2nd_abandon_cart_email', 'textarea'),
(50, '3rd Abandon Cart Email Subject', '3rd_abandon_cart_email_subject', 'textbox'),
(51, '3rd Abandon Cart Email', '3rd_abandon_cart_email', 'textarea'),
(52, 'Price Match Notification Email Subject', 'price_match_notification_email_subject', 'textbox'),
(53, 'Price Match Notification Email', 'price_match_notification_email', 'textarea'),
(54, 'Admin Failure Notification Email Subject', 'admin_failure_notification_email_subject', 'textbox'),
(55, 'Admin Failure Notification Email', 'admin_failure_notification_email', 'textarea');
...
CREATE TABLE IF NOT EXISTS `#__eshop_orderoptions` (
  ...
  KEY `idx_product_option_id` (`product_option_id`),
  KEY `idx_product_option_value_id` (`product_option_value_id`)
) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__eshop_orders` (
  ...
  `currency_code` varchar(10) DEFAULT NULL,
  `currency_exchanged_value` decimal(15,4) DEFAULT NULL,
  `coupon_id` int(11) DEFAULT NULL,
  `coupon_code` varchar(32) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_productattachments`;
CREATE TABLE IF NOT EXISTS `#__eshop_productattachments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `file_name` text,
  `published` tinyint(1) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__eshop_productdetails` (
  ...
  `product_canoncial_link` text,
  `product_price_text` text,
  `product_custom_message` text,
...
CREATE TABLE IF NOT EXISTS `#__eshop_products` (
  ...
  `product_shipping_cost_geozones` text,
...
DROP TABLE IF EXISTS `#__eshop_questions`;
CREATE TABLE `#__eshop_questions` (
  `id` int(11) NOT NULL,
  `product_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__eshop_quoteoptions` (
  ...
  KEY `idx_quote_product_id` (`quote_product_id`) ,  
  KEY `idx_product_option_id` (`product_option_id`),   
  KEY `idx_product_option_value_id` (`product_option_value_id`)
) DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `#__eshop_quotetotals`;
CREATE TABLE IF NOT EXISTS `#__eshop_quotetotals` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `quote_id` int(11) DEFAULT NULL,
  `name` varchar(32) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__eshop_taxrules` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_geozone_id` (`taxclass_id`),
  KEY `idx_published` (`tax_id`),  
...
CREATE TABLE IF NOT EXISTS `#__eshop_vouchers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `voucher_code` varchar(32) DEFAULT NULL,
  `voucher_amount` decimal(15,4) DEFAULT NULL,
  `voucher_start_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `voucher_end_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
