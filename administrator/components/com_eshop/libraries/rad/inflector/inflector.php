<?php
/**
 * The EshopRADInflector is a direct copy of Koowa's KInflector class, which
...
class EshopRADInflector
{
	...
	public static function isSingular($string)
	{
		...
		$singular = self::$_cache['singularized'][$string] ?? null;
	...
	public static function isPlural($string)
	{
		...
		$plural   = self::$_cache['pluralized'][$string] ?? null;
